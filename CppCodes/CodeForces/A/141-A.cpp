...
int main(int argc, char const *argv[]){
  /* code */
  FastIO();
  string guestName, hostName,guestHostName, shuffledName;

  cin>>guestName;
  cin>>hostName;
  cin>>shuffledName;  

  guestHostName = guestName + hostName;

  sort(guestHostName.begin(), guestHostName.end());
  sort(shuffledName.begin(), shuffledName.end());

  if(guestHostName == shuffledName) {
    cout<<"YES\n";
  }else{
    cout<<"NO\n";
  }
