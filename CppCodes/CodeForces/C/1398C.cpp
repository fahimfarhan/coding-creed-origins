...
/* thanks to https://codeforces.com/contest/1398/submission/89958092 */
...
// ll diff(const int &r, const int &l) {
//     return (cf[r] - cf[l-1]);
// }
...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    while(T--) {
        cin>>n;
        cin>>s;
        s = '\0'+s; // to convert it into a 1 based indexing
        // cf = new ll[n+1];
        // cf[0] = 0;
        // for(int i=1; i<=n; i++) {
        //     cf[i] = cf[i-1] + (s[i] - '0');
