 ...
 * geeksforgeeks is good, but they only show the pictures. Some points I donot understand (recursive case vs loop) :( 
...
void rbInsertCase1(Node *n);
void rbInsertCase2(Node *n);
void rbInsertCase3(Node *n);
void rbInsertCase4(Node *n);
void rbInsertCase5(Node *n);
...
Node* getGrandParent(Node *n){
    if((n->ancestor!=NULL) && (n->ancestor->ancestor!=NULL))
...
void rbInsertCase4(Node* x){
    // Parent (P) is red but uncle(U) is black, 
    // new node (n) is inserted as the right child of P, P is the left child of G
    Node *n,*p, *u, *g;
    n = x;
    p = n->ancestor;
    g = getGrandParent(n);
...
void rbInsertCase5(Node* x){
// Case 5:Parent (P) is red but uncle(U) is black, 
// new node (N) is inserted as the left child of P, P is the left child of G:
    Node *n,*p, *u, *g;
    n = x;
    p = n->ancestor;
    g = getGrandParent(n);
