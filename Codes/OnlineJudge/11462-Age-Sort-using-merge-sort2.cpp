...
void conquer(ll *a,ll *swapSpace, int l, int r) {
    int size = r - l + 1;
...
void divide(ll *array, ll * swapSpace, int l, int r) {
    if(r<l) {   return ; }
    if(r-l+1 == 1) {    return ; }
    int mid = (l+r) / 2;
    divide(array, swapSpace,  l, mid);
    divide(array, swapSpace, mid+1, r);
    conquer(array, swapSpace, l, r);
}

void mergeSort(ll *inputArray, ll *swapSpace, int l, int r) {
    divide(inputArray, swapSpace, l, r);
}
